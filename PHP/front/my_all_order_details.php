                                ...
                                <div class="wishlist-table table-responsive">
                                    <table>
                                        ...
                                        <tbody>
											...
											$res=mysqli_query($con,"select distinct(order_detail.order_detail_id) ,order_detail.*,product.product_name,product.product_image from order_detail,product ,`order` where `order`.customer_id='$customer_id' and order_detail.product_id=product.product_id");
											$total_price=0;
                                            ...
                                            <tr>
                                                ...
                                                <td class="product-name"> <img src="<?php echo PRODUCT_IMAGE_SITE_PATH.$row['product_image']?>" width="150px" height="150px"></td>
