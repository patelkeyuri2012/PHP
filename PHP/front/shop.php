                                ...
                                <nav class="main__menu__nav hidden-xs hidden-sm">
                                    <ul class="main__menu">
                                        <li class="drop"><a href="#"></a>
                                            <ul class="dropdown">
                                                <li><a href="sort_by_highest_price.php">Sort by Highest Price</a></li>
                                                <li><a href="sort_by_lowest_price.php">Sort by Lowest Price</a></li>
                                                <li><a href="sort_by_newest.php">Sort by Newest</a></li>
                                                <li><a href="sort_by_oldest.php">Sort by Oldest</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </nav>
